...
public class FileServer {
    ...
    protected final Map<String, FileEntry> files = new HashMap<>();
    ...
    static class FileEntry {
        ...
        FileEntry(long startPosition, long stopPosition, File f, Closeable o, String e) {
            file = f;
            inputOutputObject = o;
            charSetEncoding = e;
