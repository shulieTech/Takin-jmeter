 ...
 *
 * @author shulie
 * @date 2021-03-22 4:19 下午
 */
public class HTTPappImpl extends HTTPHCAbstractImpl {
    ...
    private static final Logger log = LoggerFactory.getLogger(HTTPappImpl.class);
    ...
    private static final class PreemptiveAuthRequestInterceptor implements HttpRequestInterceptor {
        ...
        public void process(HttpRequest request, HttpContext context) throws HttpException, IOException {
            ...
            if (authManager == null) {
                ...
                HTTPappImpl.HttpClientKey key = (HTTPappImpl.HttpClientKey) localContext.getAttribute(CONTEXT_ATTRIBUTE_CLIENT_KEY);
    ...
    private static final class JMeterDefaultHttpClientConnectionOperator extends DefaultHttpClientConnectionOperator {
        ...
        public void connect(ManagedHttpClientConnection conn, HttpHost host, InetSocketAddress localAddress,
            ...
            try {
                ...
                SampleResult sample =
                        (SampleResult)context.getAttribute(HTTPappImpl.CONTEXT_ATTRIBUTE_SAMPLER_RESULT);
                if (sample != null) {
                    sample.connectEnd();
                }
            }
    ...
    private static final HttpRequestInterceptor PREEMPTIVE_AUTH_INTERCEPTOR = new HTTPappImpl.PreemptiveAuthRequestInterceptor();
     ...
     */
    private static final ThreadLocal<Map<HTTPappImpl.HttpClientKey, MutableTriple<CloseableHttpClient, AuthState, PoolingHttpClientConnectionManager>>>
            HTTPCLIENTS_CACHE_PER_THREAD_AND_HTTPCLIENTKEY = new InheritableThreadLocal<Map<HTTPappImpl.HttpClientKey,
            MutableTriple<CloseableHttpClient, AuthState, PoolingHttpClientConnectionManager>>>() {
        @Override
        protected Map<HTTPappImpl.HttpClientKey, MutableTriple<CloseableHttpClient, AuthState, PoolingHttpClientConnectionManager>> initialValue() {
    ...
    private static final HTTPappImpl.ViewableFileBody[] EMPTY_FILE_BODIES = new HTTPappImpl.ViewableFileBody[0];
    ...
    protected HTTPappImpl(HTTPSamplerBase testElement) {
        super(testElement);
    }
    ...
    protected HTTPSampleResult sample(URL url, String method,
        ...
        HTTPappImpl.HttpClientKey key = createHttpClientKey(url);
    ...
    private HttpRequestBase createHttpRequest(URI uri, String method, boolean areFollowingRedirect) {
        ...
        if (method.equals(HTTPConstants.POST)) {
            ...
            if ( !areFollowingRedirect
                ...
                result = new HTTPappImpl.HttpGetWithEntity(uri);
            } else {
            ...
            result = new HTTPappImpl.HttpDelete(uri);
    ...
    private static final class HttpClientKey {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof HTTPappImpl.HttpClientKey)) {
                return false;
            }
            HTTPappImpl.HttpClientKey other = (HTTPappImpl.HttpClientKey) obj;
    ...
    private MutableTriple<CloseableHttpClient, AuthState, PoolingHttpClientConnectionManager> setupClient(HTTPappImpl.HttpClientKey key, JMeterVariables jMeterVariables,
                                                                                                          HttpClientContext clientContext) throws GeneralSecurityException {
        Map<HTTPappImpl.HttpClientKey, MutableTriple<CloseableHttpClient, AuthState, PoolingHttpClientConnectionManager>> mapHttpClientPerHttpClientKey =
        ...
        if (httpClient == null) { // One-time init for this client
            ...
            PoolingHttpClientConnectionManager pHCCM =
                    new PoolingHttpClientConnectionManager(
                            new HTTPappImpl.JMeterDefaultHttpClientConnectionOperator(registry, null, resolver),
            ...
            if(BASIC_AUTH_PREEMPTIVE) {
                ...
                builder.setDefaultCredentialsProvider(new HTTPappImpl.ManagedCredentialsProvider(getAuthManager(), proxyAuthScope, proxyCredentials));
            }
    ...
    private HTTPappImpl.HttpClientKey createHttpClientKey(URL url) {
        ...
        return new HTTPappImpl.HttpClientKey(url, useProxy, proxyScheme, proxyHost, proxyPort, proxyUser, proxyPass);
    }
    ...
    protected String setupHttpEntityEnclosingRequestData(HttpEntityEnclosingRequestBase entityEnclosingRequest)  throws IOException {
        ...
        if(getUseMultipart()) {
            ...
            HTTPappImpl.ViewableFileBody[] fileBodies = new HTTPappImpl.ViewableFileBody[files.length];
            for (int i=0; i < files.length; i++) {
                HTTPFileArg file = files[i];

                File reservedFile = FileServer.getFileServer().getResolvedFile(file.getPath());
                fileBodies[i] = new HTTPappImpl.ViewableFileBody(reservedFile, ContentType.create(file.getMimeType()));
...
//                    postedBody.append(postBody.toString());
     ...
     * @param postedBody
     * @param entity
     * @param fileBodies Array of {@link HTTPappImpl.ViewableFileBody}
     * @param contentEncoding
     * @throws IOException
     * @throws UnsupportedEncodingException
     */
    private void writeEntityToSB(final StringBuilder postedBody, final HttpEntity entity,
                                 final HTTPappImpl.ViewableFileBody[] fileBodies, final String contentEncoding)
            throws IOException {
        if (entity.isRepeatable()){
            ByteArrayOutputStream bos = new ByteArrayOutputStream();
            for(HTTPappImpl.ViewableFileBody fileBody : fileBodies){
...
//                    entityBodyContent.append(arg.getEncodedValue(charset));
                    argstr = arg.getEncodedValue(charset);
                } else {
//                    entityBodyContent.append(arg.getEncodedValue());
                ...
                String encstr = Base64.getEncoder().encodeToString(argstr.getBytes(StandardCharsets.UTF_8));
                encstr = URLEncoder.encode(encstr);
                entityBodyContent.append("data="+encstr);
            }
    ...
    private void closeThreadLocalConnections() {
        ...
        Map<HTTPappImpl.HttpClientKey, MutableTriple<CloseableHttpClient, AuthState, PoolingHttpClientConnectionManager>>
